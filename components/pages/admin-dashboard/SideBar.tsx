...
const userItems = [
  ...
  { title: "Manages Posts", href: "/dashboard/manage-posts", icon: FileText },
  { title: "Manages Users", href: "/dashboard/manage-users", icon: User },
  { title: "Comments", href: "/dashboard/manage-comments", icon: Command },
